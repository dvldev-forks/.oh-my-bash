...
```shell
bash -c "$(curl -fsSL https://raw.githubusercontent.com/dvldev-forks/oh-my-bash/main/tools/install.sh)"
```

#### via wget

```shell
bash -c "$(wget https://raw.githubusercontent.com/dvldev-forks/oh-my-bash/main/tools/install.sh -O -)"
```
...
Oh My Bash comes with a shit load of plugins to take advantage of. You can take a look in the [plugins](https://github.com/dvldev-forks/oh-my-bash/tree/main/plugins) directory and/or the [wiki](https://github.com/dvldev-forks/oh-my-bash/wiki/Plugins) to see what's currently available.
...
We'll admit it. Early in the Oh My Bash world, we may have gotten a bit too theme happy. We have over one hundred themes now bundled. Most of them have [screenshots](https://github.com/dvldev-forks/oh-my-bash/wiki/Themes) on our wiki or alternatively [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/wiki/themes) wiki.
...
# see https://github.com/dvldev-forks/oh-my-bash/wiki/Themes#agnoster
```
...
In case you did not find a suitable theme for your needs, please have a look at the wiki for [more of them](https://github.com/dvldev-forks/oh-my-bash/wiki/External-themes).
...
```shell
export OSH="$HOME/.dotfiles/oh-my-bash"; bash -c "$(curl -fsSL https://raw.githubusercontent.com/dvldev-forks/oh-my-bash/main/tools/install.sh)"
```
...
```sh
bash -c "$(curl -fsSL https://raw.githubusercontent.com/dvldev-forks/oh-my-bash/main/tools/install.sh)" --unattended
```
...
```sh
bash -c "$(curl -fsSL https://raw.githubusercontent.com/dvldev-forks/oh-my-bash/main/tools/install.sh)" --prefix=/usr/local
```
...
```shell
git clone https://github.com/dvldev-forks/oh-my-bash.git ~/.oh-my-bash
```
...
We also need people to test out pull-requests. So take a look through [the open issues](https://github.com/dvldev-forks/oh-my-bash/issues) and help where you can.
...
Oh My Bash is derived from [Oh My Zsh](https://github.com/dvldev-forks/ohmyzsh).
